...
import { Currency, CurrencyAmount, Fraction, Token, TradeType, NETWORK_NAME, Protocol } from "@votopia/sdk-core";
...
export class DynamoRouteCachingProvider extends IRouteCachingProvider {
  ...
  // divide those two
  private readonly DEFAULT_BLOCKS_TO_LIVE_ROUTES_DB = () => 60;
