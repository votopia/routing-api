...
import { Token, FeeAmount, Pool } from "@votopia/sdk-core";
...
export class DynamoDBCachingV3PoolProvider implements IV3PoolProvider {
  ...
  private readonly POOL_CACHE_KEY = (address: string) => `pool-${address}`;

  constructor(protected poolProvider: IV3PoolProvider, tableName: string) {
