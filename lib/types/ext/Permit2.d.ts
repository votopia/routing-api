...
interface Permit2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "permitTransferFrom((tuple[],uint256,uint256),address,tuple[],bytes)": FunctionFragment;
    "permitWitnessTransferFrom((tuple[],uint256,uint256),address,tuple[],bytes32,string,bytes)": FunctionFragment;
...
export class Permit2 extends BaseContract {
  ...
  functions: {
    ...
    "permitTransferFrom((tuple[],uint256,uint256),address,tuple[],bytes)"(
      permit: {
        permitted: { token: string; amount: BigNumberish }[];
        nonce: BigNumberish;
        deadline: BigNumberish;
    ...
    "permitWitnessTransferFrom((tuple[],uint256,uint256),address,tuple[],bytes32,string,bytes)"(
      permit: {
        permitted: { token: string; amount: BigNumberish }[];
        nonce: BigNumberish;
        deadline: BigNumberish;
