...
This repository contains routing API for the Votopia protocol.

It deploys an API to AWS that uses @votopia/smart-order-router to search for the most efficient way to swap token A for token B.
